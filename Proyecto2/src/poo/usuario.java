...
public class usuario extends persona {
    ...
    private List<libro> ListaLibrosPrestados;
     public usuario (String nombre, int edad,String direccion,String apellidos,String DNI,String email,String telefono,String profesion,int añosdeexperiencia, String numSocio){
